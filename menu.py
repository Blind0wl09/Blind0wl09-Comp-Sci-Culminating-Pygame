...
class IntroAnimation:
    def __init__(self):
        ...
        self.font = pygame.font.SysFont('Fira Code', 30, 'bold') 
...
class SimpleLoadingScreen:
    def __init__(self):
        ...
        self.font = pygame.font.SysFont('Input', 50) 

        self.display_size = pygame.display.Info().current_w, pygame.display.Info().current_h - 50
        self.screen = pygame.display.set_mode(self.display_size)

        self.bobby = pygame.image.load("bobby.png")
        self.bobby = pygame.transform.scale(self.bobby, (1080, 640))
    ...
    def draw(self):
        ...
        bobby_surface = self.font.render("Don't be a chicken!", True, (255, 255, 255))  # White text
        bobby_rect = bobby_surface.get_rect(center=(self.display_size[0] // 2, self.display_size[1] - 50))  # Bottom center
        self.screen.blit(bobby_surface, bobby_rect)
